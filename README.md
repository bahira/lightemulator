...
```
<<<<<<< HEAD
├── src/            the emulator — 12 labs (BPM, MZI, Ising/CIM, KAN, control,
│                   free energy, dispersion, SPEAR kernels, validation,
│                   PNN, holography, quantum optics)
=======
...
<<<<<<< HEAD
npm run test     # grounded loop headless: 41 tests
=======
